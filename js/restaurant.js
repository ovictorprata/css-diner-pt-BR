...
function winGame(){
  $(".tabela").html('<span class="winner"><strong>Você conseguiu!</strong><br>Agora você domina os seletores CSS.</span>');
  addNametags();
  finished = true;
  resettabela();
}
...
function loadLevel(){
  ...
  $(".level-header .level-text").html("Level " + (currentLevel+1) + " de " + levels.length);
